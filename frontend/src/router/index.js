...
const routes = [
  ...
  { path: '/admin', component: () => import('../layouts/RoleLayout.vue'), meta: { role: 'admin', title: '管理员后台' }, children: [
    ...
    { path: 'appointments', component: () => import('../views/admin/AdminAppointmentsView.vue'), meta: { title: '预约挂号' } }, 
    { path: 'visits', component: () => import('../views/admin/AdminVisitsView.vue'), meta: { title: '患者就诊' } }, 
    { path: 'hospitalizations', component: () => import('../views/admin/AdminHospitalizationsView.vue'), meta: { title: '住院登记' } }, 
    { path: 'doctors', component: () => import('../views/admin/AdminDoctorsView.vue'), meta: { title: '医生信息' } }, 
    { path: 'patients', component: () => import('../views/admin/AdminPatientsView.vue'), meta: { title: '患者信息' } }, 
    { path: 'profile', component: () => import('../views/admin/AdminProfileView.vue'), meta: { title: '管理员信息' } }, 
    { path: 'password', component: () => import('../views/admin/AdminPasswordView.vue'), meta: { title: '修改密码' } }
  ] },
  { path: '/doctor', component: () => import('../layouts/RoleLayout.vue'), meta: { role: 'doctor', title: '医生工作台' }, children: [
    ...
    { path: 'calls', component: () => import('../views/doctor/DoctorCallsView.vue'), meta: { title: '患者叫号' } }, 
    { path: 'visit', component: () => import('../views/doctor/DoctorVisitView.vue'), meta: { title: '就诊处理' } }, 
    { path: 'password', component: () => import('../views/doctor/DoctorPasswordView.vue'), meta: { title: '修改密码' } }
  ] },
  { path: '/patient', component: () => import('../layouts/RoleLayout.vue'), meta: { role: 'patient', title: '患者服务台' }, children: [
    ...
    { path: 'visits', component: () => import('../views/patient/PatientVisitsView.vue'), meta: { title: '我的就诊' } }, 
    { path: 'hospitalizations', component: () => import('../views/patient/PatientHospitalizationsView.vue'), meta: { title: '住院登记' } }, 
    { path: 'password', component: () => import('../views/patient/PatientPasswordView.vue'), meta: { title: '修改密码' } }
  ] }
]
