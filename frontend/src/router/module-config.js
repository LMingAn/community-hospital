export const roleMenus = {
  admin: [
    { key: 'home', title: '首页', icon: 'home', tabs: [ { label: '首页展示', path: '/admin/dashboard' }, { label: '系统公告', path: '/admin/announcements' } ] },
    { key: 'info', title: '信息管理', icon: 'inventory_2', tabs: [ { label: '科室信息', path: '/admin/departments' }, { label: '医生排班', path: '/admin/schedules' } ] },
  ...
  doctor: [
    { key: 'home', title: '首页', icon: 'home', tabs: [ { label: '系统公告', path: '/doctor/announcements' } ] },
    { key: 'account', title: '账号管理', icon: 'badge', tabs: [ { label: '个人信息', path: '/doctor/profile' } ] },
    ...
    { key: 'visit', title: '患者就诊', icon: 'medical_services', tabs: [ { label: '就诊处理', path: '/doctor/visit' }, { label: '修改密码', path: '/doctor/password' } ] }
  ],
  patient: [
    { key: 'home', title: '首页', icon: 'home', tabs: [ { label: '系统公告', path: '/patient/home' } ] },
    { key: 'account', title: '账号管理', icon: 'person', tabs: [ { label: '个人信息', path: '/patient/profile' } ] },
    ...
    { key: 'wallet', title: '个人中心', icon: 'account_balance_wallet', tabs: [ { label: '账户充值', path: '/patient/recharge' }, { label: '修改密码', path: '/patient/password' } ] }
  ]
}
