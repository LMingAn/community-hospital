export const roleMenus = {
  ...
  patient: [
    ...
    { key: 'visit', title: '就诊住院', icon: 'medication', tabs: [ 
      { label: '我的就诊', path: '/patient/visits' }, 
      { label: '住院登记', path: '/patient/hospitalizations' } ] 
    },
    { key: 'center', title: '个人中心', icon: 'account_balance_wallet', tabs: [ 
