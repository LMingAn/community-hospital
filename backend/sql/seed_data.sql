...
('admin', sha2('123456', 256), '管理员', '1210000001', 'admin@hosp.local');

insert into doctors (dept_id, username, password_hash, name, gender, title, specialty, phone, profile) values
(1, 'doctor01', sha2('123456', 256), '王丽', '女', '主治医师', '发热咳嗽胃肠不适', '1220000001', '从事基层全科接诊多年，熟悉社区常见病诊疗流程。'),
(1, 'doctor02', sha2('123456', 256), '张强', '男', '住院医师', '感冒体检基础门诊', '1220000002', '擅长常见轻症筛查与健康宣教。'),
(2, 'doctor03', sha2('123456', 256), '李敏', '女', '副主任医师', '高血压糖尿病慢病随访', '1220000003', '长期从事慢病管理和复诊工作。'),
(3, 'doctor04', sha2('123456', 256), '陈晨', '女', '主治医师', '儿童发热保健咨询', '1220000004', '擅长儿童常见病和保健评估。');

insert into patients (username, password_hash, name, gender, age, phone, identity_card_no) values
('patient01', sha2('123456', 256), '刘芳', '女', 29, '1230000001', '123000000000000001'),
('patient02', sha2('123456', 256), '赵明', '男', 45, '1230000002', '123000000000000002');
